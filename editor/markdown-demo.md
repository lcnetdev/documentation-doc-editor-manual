...
External links open in a new tab automatically: [Library of Congress](https://www.loc.gov)
...
![](images/sample-diagram.png)
![sample image with caption](../images/image-1773764125942.png)


Images with generic alt text render without a caption:

![image](../images/image-1773764125942.png)
